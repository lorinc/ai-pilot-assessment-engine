# Phase 2: Discovery & Assessment Implementation Scaffold
...
**Foundation:** Phase 1 infrastructure (auth, persistence, streaming chat) is operational.
...
### Not in Phase 2
- Context extraction (budget, timeline, visibility) → Phase 3
...
- `pilot_catalog.json` → Phase 4
- `pilot_types.json` → Phase 4
- `capability_framework.json` → Phase 4
- `inference_rules/` → Phase 3-4
