# Release 2.5: UX & Quality Infrastructure
...
Two parallel tracks that must exist BEFORE Release 3 complexity:
...
**Why 2.5:** Quality and UX infrastructure must exist BEFORE adding complexity in Release 3+.
...
**Dependencies:** Release 2 in progress  
**Timeline:** 4 weeks parallel tracks alongside Release 2
