...
### Phase 3: Intent Detection (Week 3)

**Goal**: Replace phase-based routing with intent detection
...
**Phase 1-2**: Dual tracking
- Keep existing phase logic
...
**Dependencies**: Phase 2 complete, atomic behaviors defined  
...
- **UX Patterns**: `docs/2_technical_spec/Phase2.5/USER_INTERACTION_PATTERNS.md` - Pattern system

---

**Owner**: Technical Lead  
**Priority**: High - Blocks Phase 3 conversation quality  
